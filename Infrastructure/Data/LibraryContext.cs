...
public class LibraryContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Book>().HasData(
            ...
            new Book { Id = 1, Title = "Fogo & Sangue", Author = "Geaorge R.R. Martin", CreatedDate = DateTime.Now.AddMonths(-8) },
            new Book { Id = 2, Title = "O Acerto de Contas de Uma Mãe", Author = "Sue Klebold", CreatedDate = DateTime.Now.AddMonths(-2) },
            new Book { Id = 3, Title = "Poesias", Author = "Edgar Allan Poe", CreatedDate = DateTime.Now.AddMonths(-1) }
        );
